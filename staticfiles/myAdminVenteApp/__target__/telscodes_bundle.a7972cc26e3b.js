var telscodes = (function (exports) {
    'use strict';

    // Transcrypt'ed from Python, 2019-09-06 13:29:25
    ...
    // Transcrypt'ed from Python, 2019-09-06 17:27:27
    var filter_tel = function (tel, data) {
    	var lst = [];
    	for (var telcode of data) {
    ...
    var result = function (tel, data) {
    	var lst = filter_tel (tel, data);
    	var html = '';
    	for (var telcode of lst) {
    		html += '<tr><td> {}</td><td> {}</td><td> {} </td></tr>'.format ('7777', telcode ['tel'], telcode ['code']);
    	}
    	return html;
    };
    var action = function () {
    	var tel = document.getElementById ('tel').value;
    	var html = result (tel, window.data);
    	alert (html);
    	document.getElementById ('t').innerHTML += html;
    };

    exports.action = action;
    exports.filter_tel = filter_tel;
