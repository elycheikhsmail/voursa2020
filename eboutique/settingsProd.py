...
# /var/www/html/eboutique_static
STATIC_ROOT = '/var/www/html/eboutique_static'
STATIC_URL = 'http://localhost/eboutique_static/'
# ajouter mn


MEDIA_ROOT = '/var/www/html/eboutique_media'
MEDIA_URL = 'http://localhost/eboutique_media/'
